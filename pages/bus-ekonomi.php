...
<html lang="en">
  ...
  <body>
    ...
    <div class="ekonomi">
      <div class="bus">
        <img src="../images/1-bus-ekonomi.jpg"alt="Bus Ekonomi">
        <div class="txt-bus">
          <p> Bus Ekonomi</p>
        </div>
      ...
      <div class="interior">
        <img src="../images/1-in-ekonomi.jpg"alt="Interior Ekonomi">
        <div class="txt-bus">
          <p> Interior Kelas Ekonomi</p>
        </div>
        <div class="judul-deskripsi">
          Fasilitas :
        </div>
        <div class="deskripsi-bus">
        Kursi 2-2 <br>Toilet <br>Video Player
        </div>
      </div>
    </div>
