...
<html lang="en">
  ...
  <body>
    ...
    <div class="ekonomi">
      <div class="bus">
        <img src="../images/2-bus-bisnis.jpg"alt="Bus Bisnis" >
        <div class="txt-bus">
          <p>Bus Bisnis</p>
        </div>
      ...
      <div class="interior">
        <img src="../images/2-in-bisnis.jpg"alt="Interior Bisnis"height="332">
        <div class="txt-bus">
          <p> Interior Bisnis</p>
        </div>
        <div class="judul-deskripsi">
        ...
        <div class="deskripsi-bus">
          AC <br>Kapasitas 36-39 orang <br>Toilet <br>Video Player
        </div>
      </div>
    </div>
